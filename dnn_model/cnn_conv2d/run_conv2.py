...
base_dir = '/opt/algor/gongxf/python3_pj/nlp_practice/5_context_classification/dnn_model/data/'
train_dir = os.path.join(base_dir, 'train.txt')
test_dir = os.path.join(base_dir, 'test.txt')
val_dir = os.path.join(base_dir, 'test.txt')
vocab_dir = os.path.join(base_dir, 'vocab_word2vec.txt')

save_dir = '/opt/algor/gongxf/python3_pj/nlp_practice/5_context_classification/dnn_model/result_conv2d/'
...
ff_pool=open("/opt/algor/gongxf/python3_pj/nlp_practice/5_context_classification/dnn_model/data/test_pool.txt",'w',encoding='utf-8')
...
class Run(object):
    ...
    def prediction(self):
        ...
        while True:
            text = input("请输入测试问题：")
            x_test = process_file_predict(text, word_to_id, cat_to_id, config.seq_length)
            print("x_test", x_test)
            feed_dict = {
